...
import tesseract
def main(txt)
    #Text Detector Funtion using Stroke Width Calculation
...
fn = raw_input('Enter a file name:').strip()#When typing  dont forget to add "\" before the the image name 
